...
<script>
  ...
  // Installation docs
  const installDocs = `$ yarn add https://github.com/reuters-graphics/chart-module-vaccination-income.git`;

  // JavaScript docs
  $: jsDocs = `import Chart from '@reuters-graphics/vaccination-income';
...
`;
  ...
  // SCSS docs
  const styleDocs = `$IncomeVaccinations-container: '.vaccination-income-container';

@import '~@reuters-graphics/vaccination-income/src/scss/chart';`;
...
<div class='repo-link'>
  <a href="https://github.com/reuters-graphics/chart-module-vaccination-income" target="_blank">
    <Icon icon={faGithub} />
  </a>
</div>
